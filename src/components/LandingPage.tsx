...
import { ArrowRight, Check, Layers, Link2, Shield, Zap, Mail, Lock, Loader2 } from 'lucide-react';
  ...
  const handleAuth = async (e: React.FormEvent) => {
    ...
    try {
      if (isLogin) {
        ...
        if (error) throw error;
        toast.success('Account created! You can now continue.');
      }
          ...
          <div className="container mx-auto max-w-4xl">
            <div className="text-center mb-12">
              ...
              <p className="mt-6 text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto animate-slide-up" style={{ animationDelay: '100ms' }}>
                Connect your Zendesk support data directly to your Stripe dashboard. View customer profiles and support tickets without switching tabs.
              </p>
            </div>
            ...
            {!isAuthenticated ? (
              <div className="max-w-md mx-auto animate-slide-up" style={{ animationDelay: '200ms' }}>
                <div className="p-8 rounded-xl border bg-card shadow-lg">
                  ...
                  <form onSubmit={handleAuth} className="space-y-4">
                    ...
                    <Button type="submit" variant="stripe" className="w-full" disabled={isLoading}>
                      {isLoading ? (
              ...
              <div className="text-center animate-fade-in">
                <div className="inline-flex items-center gap-2 text-success mb-6">
                  <Check className="h-5 w-5" />
                  <span className="font-medium">You're signed in!</span>
                </div>
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                  <Button variant="stripe" size="xl" onClick={onLaunchDemo}>
                    Launch Demo
